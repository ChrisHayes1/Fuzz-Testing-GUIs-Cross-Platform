...
#ifndef HPUX
// Todd - I removed these, they are conflicting with make.
...
// new.h does not exist, it is referenced in New.H as well, siuggesting it is something different.
//#include "new.h"
